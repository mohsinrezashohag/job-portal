...
import { editJobThunk } from '../rtk/features/jobs/jobsSlice';

const EditJob = () => {

    const { editingNow } = useSelector(state => state.jobs)

    const [input, setInput] = useState({ title: editingNow?.title, type: editingNow?.type, salary: editingNow?.salary, deadline: editingNow?.deadline, })
    ...
    const handleSubmit = (e) => {
        e.preventDefault()
        dispatch(editJobThunk({ id: editingNow.id, updateData: input }))
        reset()
        ...
        <div className="max-w-[90rem] mx-auto px-4 sm:px-6 md:px-8">
            ...
            <div className="lg:pl-[14rem] mt-[5.8125rem]">
                <main className="max-w-3xl rounded-lg mx-auto relative z-20 p-10 xl:max-w-none bg-[#1E293B]">
                    <h1 className="mb-10 text-center my-section-title">Edit Job Now</h1>
